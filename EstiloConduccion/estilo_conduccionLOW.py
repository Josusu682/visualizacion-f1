...
# Prueba Unitaria: Monza 2024 (Curva 1 - Rettifilo)
# La recta principal termina aprox en el metro 600, y la salida de la curva es por el 1000
if __name__ == '__main__':
    try:
        analizar_micro_curva(2024, 'Italy', distancia_min=500, distancia_max=1200, nombre_curva="Curva 1 Rettifilo")
